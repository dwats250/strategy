# PREMIUM CAMPAIGN MANIFEST — v2.1 (FROZEN) · 2026-07-22
...
| QQQ replication | `qqq_orb_replication_v1_1_4.pine` | **v1.1.4-rep** |
...
| R2 | QQQ 5m, ETH off | v1.1.4 · frozen params (1%/10R/4×) | 2010-01-01 → today (max) | `deep_R2_QQQ_full.csv` |
